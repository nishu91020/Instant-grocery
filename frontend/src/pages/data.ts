...
export interface OutputProductType {
	id: String;
	name: String;
	type: String;
	quantity: Number;
...
const filterProducts = (products: InputProductType[]): OutputProductType[] => {
	let newProducts = products.map((product: InputProductType) => {
		const newProduct: OutputProductType = {
			id: crypto.randomUUID(),
			name: product.title,
			type: product.type,
...
export default filterProducts(PRODUCTS);
